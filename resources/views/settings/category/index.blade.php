...
@section('content')
    <div class="flex h-full max-h-full overflow-hidden gap-4">
        ...
        <main class="flex-1 h-full overflow-y-auto">
            <div class="mb-5">
                <h1 class="text-base font-semibold text-slate-800">Daftar Kategori Barang</h1>
                <p class="text-sm text-slate-500 mt-0.5">Kelola kategori barang</p>
            </div>
                        ...
                        <tbody class="divide-y divide-slate-100">
                            @foreach ($categories as $index => $category)
                                <tr class="hover:bg-slate-50 transition-colors">
                                    ...
                                    <td class="p-3 text-slate-700 uppercase">{{ $category->category_name }}</td>
                                    <td class="p-3">
